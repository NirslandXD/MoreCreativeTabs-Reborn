...
public class MoreCreativeTabs {
    ...
    public static TabReloadResult reloadTabs(ResourceManager resourceManager) {
        ...
        DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> {
            ...
            result[0] = CustomCreativeTabManager.createReloadResult(customTabs.size(), policyFiles[0], policyFiles[1]);
            if (entries.isEmpty()) {
        ...
        return result[0] == null ? CustomCreativeTabManager.createReloadResult(0, 0, 0) : result[0];
    }
